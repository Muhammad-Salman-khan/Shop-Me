  ...
  return (
    <>
      <div className="container mx-auto px-4">
        <div className="flex justify-center flex-col min-h-screen align-middle items-center">
          <div className="w-full max-w-4xl mt-8 mb-8 md:mt-12 md:mb-12">
            <svg
              width="100%"
              height="auto"
              viewBox="0 0 636 324"
